      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            <ul className="ml-5">
              <li>
                <span className="text-blue">config import [url]</span> Imports remote config JSON
              </li>
              <li>
                <span className="text-blue">config theme [theme-name]</span> Switches theme
              </li>
              <li>
                <span className="text-blue">config edit</span> Opens local config in editor
              </li>
              <li>
                <span className="text-blue">config reset</span> Resets to default config
              </li>
            </ul>
          </li>
        </ul>
