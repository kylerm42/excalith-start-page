          ...
          <div className="mx-auto">
            <div className="row">
              ...
              <ul className="mt-line">
                <li>
                  <span className={`text-${titleColor}`}>OS:</span> {browserData.osName}
                </li>
                <li>
                  <span className={`text-${titleColor}`}>Browser:</span> {browserData.browser}
                </li>
                <li>
                ...
                <li>
                  <span className={`text-${titleColor}`}>Engine:</span> {browserData.engineName}
                </li>
              </ul>
